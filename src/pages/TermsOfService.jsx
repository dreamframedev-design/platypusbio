  ...
  return (
    <main className="min-h-screen bg-[#fbfbf9] pt-[160px] pb-[120px] relative overflow-hidden">
      ...
      <div className="section-container relative z-10 max-w-[900px] mx-auto px-8">
        ...
        <div className="reveal glass-card-light p-8 md:p-16 rounded-[2rem] border-t-2 border-[#0d9488]/60 shadow-[0_16px_48px_rgba(0,0,0,0.06)] bg-white/80 backdrop-blur-xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[radial-gradient(circle,rgba(13,148,136,0.05)_0%,transparent_70%)] blur-[40px] pointer-events-none" />
          ...
          <div className="max-w-none relative z-10 text-slate-600 font-light leading-[1.85]">
            ...
            <h2 className="text-[1.75rem] font-bold text-slate-900 tracking-tight mt-12 mb-6">1. Agreement to Terms</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[1.75rem] font-bold text-slate-900 tracking-tight mt-12 mb-6">2. Use License</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[1.75rem] font-bold text-slate-900 tracking-tight mt-12 mb-6">3. Disclaimer</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[1.75rem] font-bold text-slate-900 tracking-tight mt-12 mb-6">4. Limitations</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[1.75rem] font-bold text-slate-900 tracking-tight mt-12 mb-6">5. Revisions and Errata</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[1.75rem] font-bold text-slate-900 tracking-tight mt-12 mb-6">6. Governing Law</h2>
            <p className="mb-6">
