        ...
        <div className="w-full max-w-[720px] text-left p-7 md:p-10 lg:p-12 rounded-2xl backdrop-blur-2xl bg-white/40 border border-white/60 shadow-[0_32px_64px_rgba(0,0,0,0.15)] relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="animate-fade-in-up delay-400 text-[clamp(1.05rem,1.15vw,1.15rem)] text-slate-800 mb-[48px] leading-[1.8] font-medium tracking-[0.01em] max-w-[600px] drop-shadow-sm">
              TRICK (Trigger RNA-Induced Cell Killing) is a programmable RNA-targeted platform that is engineered to recognise disease-driving RNA transcripts inside cancer cells and trigger selective cell death, while leaving healthy cells unharmed.
            </p>
