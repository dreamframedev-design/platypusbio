...
const AnimatedPlatypusLogo = () => {
  return (
    <div className="group relative w-[72px] h-[72px] flex items-center justify-center cursor-pointer">
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-[#d46b1a] to-[#2dd4bf] rounded-full blur-[20px] opacity-0 group-hover:opacity-60 transition-all duration-700 group-hover:scale-125" />
      
      {/* The SVG */}
      <svg 
        viewBox="0 0 358 349" 
        className="w-full h-full relative z-10 transition-all duration-500 group-hover:scale-110"
      >
        <defs>
        ...
        <g fill="url(#platypus-gradient)" className="opacity-90 group-hover:opacity-100 transition-opacity duration-500">
