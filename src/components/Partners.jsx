...
export default function Partners() {
  ...
  return (
    <section id="partners" ref={sectionRef} style={{ position: 'relative', paddingTop: '128px', paddingBottom: '128px', overflow: 'hidden', backgroundColor: '#fbfbf9' }}>
      ...
      <div className="section-container" style={{ position: 'relative', zIndex: 10 }}>
        <div className="section-divider" style={{ marginBottom: '80px', opacity: 0.5 }} />
          ...
          <p style={{ color: '#475569', fontSize: '1.0625rem', lineHeight: 1.75, marginBottom: '64px', fontWeight: 300 }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} style={{
                    ...
                    <span style={{ color: '#64748b', fontSize: '0.75rem', fontWeight: 500 }}>Partner Logo</span>
                  </div>
                ))}
              </div>
